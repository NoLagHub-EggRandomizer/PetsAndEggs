...
local eggChances = {
    ...
    ["Mythic Egg"] = {["Grey Mouse"] = 37.5, ["Brown Mouse"] = 26.79, ["Squirrel"] = 26.79, ["Red Giant Ant"] = 8.93},
    ...
    ["Paradise Egg"] = {["Ostrich"] = 43, ["Peacock"] = 33, ["Capybara"] = 24, ["Scarlet Macaw"] = 3},
    ["Premium Night Egg"] = {["Hedgehog"] = 50, ["Mole"] = 26, ["Frog"] = 14, ["Echo Frog"] = 10},
    ["Oasis Egg"] = {["Meerkat"] = 45, ["Sand Snake"] = 34.5, ["Axolotl"] = 15, ["Hyacinth Macaw"] = 5},
    ["Dinosaur Egg"] = {["Raptor"] = 35, ["Triceratops"] = 32.5, ["Stegosaurus"] = 28, ["Pterodactyl"] = 3},
...
rerollBtn.MouseButton1Click:Connect(function()
    if isCooldown then return end -- Prevent clicking during cooldown
    isCooldown = true
    ...
    local countdown = 3
    local originalText = "[B] Reroll Pet Display"
    rerollBtn.Text = "[B] Cooldown: " .. countdown .. "s"
    ...
    local function countdownTick()
        ...
        if countdown > 0 then
            rerollBtn.Text = "[B] Cooldown: " .. countdown .. "s"
            task.delay(1, countdownTick)
        else
            rerollBtn.Text = originalText
